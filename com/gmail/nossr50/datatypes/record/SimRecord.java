...
public class SimRecord {
	...
	public void addStat(EntityAlignment ea, RecordType rt, int addStat)
	{
	 ...
	 */
	public int getTurnStat(EntityAlignment ea, Turn turn, RecordType stat)
	{
		return laneRecords.getRecord(ea, turn).getStat(stat);
	}
	
	
	public int getAllTurnSumStat(EntityAlignment ea, RecordType stat)
	{
		int allTurnSum = 0;
